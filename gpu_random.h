...
//     struct gpu_Ran {    };
    ...
    void gr_fill_surface_taucd_gauss_rand(gpu_Ran *gr,int sz,int count,bool SDCD_toggle,cudaArray*  d_taucd_gauss_rand); //Fills surface rand_buffer with vectors of {1x uniformaly distributed (0,1] random numbers and 3x normally distributed (mean 0, varience 1) random numbers}. They are used for (\tau_CD, \bm{Q_i} generation)
